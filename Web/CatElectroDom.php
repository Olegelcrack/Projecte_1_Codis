...
<html lang="ca">
    <head>
        <meta charset="UTF-8" />
        <title>Stock Electrodomestics</title>
            ...
            <div class="table">
                ...
                <table id="taula">
                    ...
                    try{
                        ...
                        foreach($db->query("SELECT * FROM productes p, proveidor pro, pertany per where p.Codi_prov=pro.Codi_pro and Codi_cat=2 and p.Codi_id=per.Codi_id") as $row){
