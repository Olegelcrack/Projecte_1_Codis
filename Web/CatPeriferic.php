            ...
            <div class="table">
                ...
                <table id="taula">
                    ...
                    try{
                        ...
                        foreach($db->query("SELECT * FROM productes p, proveidor pro, pertany per where p.Codi_prov=pro.Codi_pro and Codi_cat=4 and p.Codi_id=per.Codi_id") as $row){
